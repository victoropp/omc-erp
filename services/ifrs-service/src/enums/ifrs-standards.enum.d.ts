 ...
 */
export declare enum IFRS9Classification {
 ...
 */
export declare enum IFRS9Stage {
 ...
 */
export declare enum IFRS15RecognitionMethod {
 ...
 */
export declare enum IFRS16LeaseType {
    FINANCE_LEASE = "FINANCE_LEASE",
    OPERATING_LEASE = "OPERATING_LEASE"
}
export declare enum IFRS16Perspective {
    LESSEE = "LESSEE",
    LESSOR = "LESSOR"
}
/**
 ...
 */
export declare enum IAS2ValuationMethod {
    FIFO = "FIFO",
 ...
 */
export declare enum IAS36TestingMethod {
 ...
 */
export declare enum IAS21CurrencyType {
    FUNCTIONAL = "FUNCTIONAL",
    PRESENTATION = "PRESENTATION",
    FOREIGN = "FOREIGN"
}
export declare enum IAS21TranslationMethod {
    CURRENT_RATE = "CURRENT_RATE",
    TEMPORAL = "TEMPORAL",
    CURRENT_NON_CURRENT = "CURRENT_NON_CURRENT"
}
//# sourceMappingURL=ifrs-standards.enum.d.ts.map