...
exports.DeliveryValidationService = void 0;
const common_1 = require("@nestjs/common");
const daily_delivery_entity_1 = require("../entities/daily-delivery.entity");
let DeliveryValidationService = class DeliveryValidationService {
    async validateDelivery(deliveryData) {
        const errors = [];
        const warnings = [];
        ...
        if (!deliveryData.depotId)
            errors.push('Depot is required');
        if (!deliveryData.psaNumber)
            errors.push('PSA number is required');
        ...
        if (deliveryData.productType === daily_delivery_entity_1.ProductGrade.PMS || deliveryData.productType === daily_delivery_entity_1.ProductGrade.AGO) {
    ...
    async validateForApproval(delivery) {
        ...
        if (delivery.productType === daily_delivery_entity_1.ProductGrade.PMS || delivery.productType === daily_delivery_entity_1.ProductGrade.AGO) {
    ...
    async validateForInvoicing(delivery) {
        const errors = [];
        const warnings = [];
    ...
    async validateDeliveryUpdate(currentDelivery, updateData) {
        const errors = [];
        const warnings = [];
    ...
    validateBusinessRules(delivery) {
        const errors = [];
        const warnings = [];
        ...
        const minQuantities = {
            [daily_delivery_entity_1.ProductGrade.PMS]: 1000,
            [daily_delivery_entity_1.ProductGrade.AGO]: 1000,
            [daily_delivery_entity_1.ProductGrade.IFO]: 5000,
            [daily_delivery_entity_1.ProductGrade.LPG]: 500,
            [daily_delivery_entity_1.ProductGrade.KEROSENE]: 500,
            [daily_delivery_entity_1.ProductGrade.LUBRICANTS]: 100,
        };
    ...
    validateGhanaCompliance(delivery) {
        const errors = [];
        const warnings = [];
        // NPA compliance for controlled products
        const controlledProducts = [daily_delivery_entity_1.ProductGrade.PMS, daily_delivery_entity_1.ProductGrade.AGO, daily_delivery_entity_1.ProductGrade.KEROSENE];
...
exports.DeliveryValidationService = DeliveryValidationService;
exports.DeliveryValidationService = DeliveryValidationService = __decorate([
    (0, common_1.Injectable)()
], DeliveryValidationService);
//# sourceMappingURL=delivery-validation.service.js.map