...
exports.CreateDailyDeliveryTables1703001000000 = void 0;
const typeorm_1 = require("typeorm");
class CreateDailyDeliveryTables1703001000000 {
    ...
    async up(queryRunner) {
        ...
        // Create indexes
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_tenant_delivery_date', ['tenant_id', 'delivery_date']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_tenant_status', ['tenant_id', 'status']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_tenant_supplier', ['tenant_id', 'supplier_id']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_tenant_customer', ['tenant_id', 'customer_id']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_tenant_depot', ['tenant_id', 'depot_id']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_psa_number', ['psa_number']));
        await queryRunner.createIndex('daily_deliveries', new typeorm_1.Index('IDX_daily_deliveries_waybill_number', ['waybill_number']));
        await queryRunner.createIndex('delivery_line_items', new typeorm_1.Index('IDX_delivery_line_items_delivery_id', ['delivery_id']));
        await queryRunner.createIndex('delivery_approval_history', new typeorm_1.Index('IDX_delivery_approval_history_delivery_id', ['delivery_id']));
        await queryRunner.createIndex('delivery_approval_history', new typeorm_1.Index('IDX_delivery_approval_history_approved_by', ['approved_by']));
        await queryRunner.createIndex('delivery_documents', new typeorm_1.Index('IDX_delivery_documents_delivery_id', ['delivery_id']));
        await queryRunner.createIndex('delivery_documents', new typeorm_1.Index('IDX_delivery_documents_document_type', ['document_type']));
        // Create foreign keys
        await queryRunner.createForeignKey('delivery_line_items', new typeorm_1.ForeignKey({
            columnNames: ['delivery_id'],
            referencedColumnNames: ['id'],
            referencedTableName: 'daily_deliveries',
            onDelete: 'CASCADE',
        }));
        await queryRunner.createForeignKey('delivery_approval_history', new typeorm_1.ForeignKey({
            columnNames: ['delivery_id'],
            referencedColumnNames: ['id'],
            referencedTableName: 'daily_deliveries',
            onDelete: 'CASCADE',
        }));
        await queryRunner.createForeignKey('delivery_documents', new typeorm_1.ForeignKey({
            columnNames: ['delivery_id'],
            referencedColumnNames: ['id'],
            referencedTableName: 'daily_deliveries',
            onDelete: 'CASCADE',
    ...
    async down(queryRunner) {
        ...
        if (deliveryLineItemsTable) {
            const foreignKey = deliveryLineItemsTable.foreignKeys.find((fk) => fk.columnNames.indexOf('delivery_id') !== -1);
            if (foreignKey) {
                await queryRunner.dropForeignKey('delivery_line_items', foreignKey);
            }
        }
        if (deliveryApprovalHistoryTable) {
            const foreignKey = deliveryApprovalHistoryTable.foreignKeys.find((fk) => fk.columnNames.indexOf('delivery_id') !== -1);
            if (foreignKey) {
                await queryRunner.dropForeignKey('delivery_approval_history', foreignKey);
            }
        }
        if (deliveryDocumentsTable) {
            const foreignKey = deliveryDocumentsTable.foreignKeys.find((fk) => fk.columnNames.indexOf('delivery_id') !== -1);
            if (foreignKey) {
...
exports.CreateDailyDeliveryTables1703001000000 = CreateDailyDeliveryTables1703001000000;
//# sourceMappingURL=create-daily-delivery-tables.js.map