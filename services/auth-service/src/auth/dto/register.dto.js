...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '+233244123456', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: shared_types_1.UserRole, example: shared_types_1.UserRole.OPERATOR }),
    (0, class_validator_1.IsOptional)(),
