...
describe('AuthService', () => {
    ...
    describe('validateUser', () => {
        ...
        it('should throw ForbiddenException for suspended user', async () => {
            // Arrange
            const suspendedUser = { ...mockUser, status: shared_types_1.UserStatus.SUSPENDED };
        ...
        it('should throw ForbiddenException for inactive user', async () => {
            // Arrange
            const inactiveUser = { ...mockUser, status: shared_types_1.UserStatus.INACTIVE };
    ...
    describe('Performance Tests', () => {
        it('should handle concurrent login attempts efficiently', async () => {
            ...
            mockUser.validatePassword.mockResolvedValue(true);
            usersService.findByUsername.mockResolvedValue(mockUser);
            const concurrentLogins = Array(10).fill(null).map(() => service.validateUser('testuser', 'password', 'tenant-123'));
            // Act
