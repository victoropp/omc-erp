...
var BackgroundAutomationService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.BackgroundAutomationService = void 0;
...
let BackgroundAutomationService = BackgroundAutomationService_1 = class BackgroundAutomationService {
    schedulerRegistry;
    eventEmitter;
    pricingWindowService;
    uppfClaimsService;
    priceCalculationService;
    logger = new common_1.Logger(BackgroundAutomationService_1.name);
    jobStatuses = new Map();
    constructor(schedulerRegistry, eventEmitter, pricingWindowService, uppfClaimsService, priceCalculationService) {
     ...
     */
    async createBiWeeklyPricingWindow() {
        ...
        const result = await this.executeJob(jobName, async () => {
            ...
            await this.pricingWindowService.calculateAndPublishPrices(newWindow.windowId, 'SYSTEM_AUTOMATED');
     ...
     */
    async performDailyPriceValidation() {
        ...
        const result = await this.executeJob(jobName, async () => {
            ...
            const validationResult = await this.priceCalculationService.validatePriceLogic(currentWindow.windowId);
    ...
    async processWeeklyUppfClaims() {
        ...
        const result = await this.executeJob(jobName, async () => {
            ...
            const submissionResult = await this.uppfClaimsService.submitClaimsToNpa(currentWindow.windowId, 'SYSTEM_AUTOMATED');
            // Generate UPPF claims summary
            const claimsSummary = await this.uppfClaimsService.getClaimsSummary(currentWindow.windowId);
    ...
    async generateDailyReports() {
        ...
        const result = await this.executeJob(jobName, async () => {
            ...
            const uppfReport = await this.uppfClaimsService.generateClaimsReport(yesterday, currentDate, 'summary');
     ...
     */
    async processWeeklyNpaSubmissions() {
...
], BackgroundAutomationService.prototype, "createBiWeeklyPricingWindow", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "performDailyPriceValidation", null);
__decorate([
    (0, schedule_1.Cron)('0 14 * * 5', {
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "processWeeklyUppfClaims", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "performMonthlyArchiving", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "generateDailyReports", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "processWeeklyNpaSubmissions", null);
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BackgroundAutomationService.prototype, "performSystemHealthCheck", null);
exports.BackgroundAutomationService = BackgroundAutomationService = BackgroundAutomationService_1 = __decorate([
...
//# sourceMappingURL=background-automation.service.js.map