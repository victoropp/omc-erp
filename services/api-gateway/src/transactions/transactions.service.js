...
let TransactionsService = class TransactionsService {
    ...
    async getTransactionStats(headers) {
        return this.proxyService.forwardRequest(this.serviceName, 'GET', '/stats', null, headers);
    }
    async getLiveTransactions(headers) {
        return this.proxyService.forwardRequest(this.serviceName, 'GET', '/live', null, headers);
    }
    ...
    async updateTransaction(id, data, headers) {
