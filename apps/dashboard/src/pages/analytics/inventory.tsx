...
const InventoryAnalytics = () => {
  ...
  if (loading) {
    return (
      <FuturisticDashboardLayout title="Inventory Analytics" subtitle="Stock management and optimization insights">
  ...
  return (
    <FuturisticDashboardLayout 
      ...
      subtitle="Stock management and optimization insights"
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline">Optimize Stock</Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <AreaChart data={data?.trends?.stockLevels} height={300} />
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <LineChart data={data?.trends?.turnover} height={300} />
              </CardContent>
            </Card>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <BarChart data={data?.breakdown?.byCategory} height={300} />
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <PieChart data={data?.breakdown?.byLocation} height={300} />
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <BarChart data={data?.breakdown?.ageAnalysis} height={300} />
              </CardContent>
            </Card>
          </motion.div>
        </div>
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {data?.analysis?.stockAlerts?.map((alert: any, index: number) => (
                      <tr key={alert.product} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <td className="py-3 px-4">
                          <Badge variant={getAlertColor(alert.status)}>
                            {alert.status}
                          </Badge>
                        </td>
                        <td className="py-3 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="p-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  {data?.analysis?.fastMoving?.map((item: any, index: number) => (
                    <div key={item.product} className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      <div>
          ...
          >
            <Card className="p-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  {data?.analysis?.slowMoving?.map((item: any, index: number) => (
                    <div key={item.product} className="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                      <div>
                        <p className="font-medium">{item.product}</p>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {item.daysOfStock} days of stock
        ...
        >
          <Card className="p-6">
            ...
            <CardContent>
              <AreaChart data={data?.trends?.valuation} height={300} />
            </CardContent>
          </Card>
        </motion.div>
      </div>
