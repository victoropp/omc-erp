...
const OperationalAnalytics = () => {
    ...
    const fetchOperationalData = async () => {
        try {
            setLoading(true);
            const response = await api_1.analyticsService.getOperationalAnalytics();
            setData(response);
        }
        catch (error) {
    ...
    if (loading) {
        return (<FuturisticDashboardLayout_1.FuturisticDashboardLayout title="Operational Analytics" subtitle="Operational efficiency and performance metrics">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
          <div className="flex flex-wrap gap-4">
            ...
            <Select_1.Select value={selectedStation} onChange={(value) => setSelectedStation(value)} options={stationOptions} className="w-48"/>
          </div>
          
          <div className="flex gap-2">
            <Button_1.Button variant="outline">Operations Report</Button_1.Button>
            <Button_1.Button variant="outline">Schedule Maintenance</Button_1.Button>
          </div>
        </div>
            ...
            },
            {
              ...
              <Card_1.Card className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <ui_1.Badge variant={getStatusColor(parseFloat(metric.value), { good: 90, warning: 75 })}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.AreaChart data={data?.performance?.throughputTrend} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.7 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.LineChart data={data?.performance?.uptimeTrend} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }}>
          <Card_1.Card className="p-6">
            ...
            <Card_1.CardContent>
              <charts_1.BarChart data={data?.performance?.stationPerformance} height={300}/>
            </Card_1.CardContent>
          </Card_1.Card>
        </framer_motion_1.motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.BarChart data={data?.efficiency?.processEfficiency} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.0 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.BarChart data={data?.efficiency?.resourceUtilization} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.PieChart data={data?.efficiency?.wasteMetrics} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.2 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.AreaChart data={data?.quality?.qualityMetrics} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.3 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.LineChart data={data?.quality?.defectTrend} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.4 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.PieChart data={data?.quality?.complianceScore} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.5 }}>
            <Card_1.Card className="p-6">
              ...
              <Card_1.CardContent>
                <charts_1.PieChart data={data?.maintenance?.maintenanceSchedule} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>

          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.6 }}>
            <Card_1.Card className="p-6">
              <Card_1.CardHeader>
              ...
              <Card_1.CardContent>
                <charts_1.PieChart data={data?.maintenance?.equipmentHealth} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>

          <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.7 }}>
            <Card_1.Card className="p-6">
              <Card_1.CardHeader>
              ...
              <Card_1.CardContent>
                <charts_1.LineChart data={data?.maintenance?.mttrTrend} height={300}/>
              </Card_1.CardContent>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.8 }}>
          <Card_1.Card className="p-6">
            <Card_1.CardHeader>
...
exports.default = OperationalAnalytics;
