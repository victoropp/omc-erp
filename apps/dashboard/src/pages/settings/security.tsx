...
const SecuritySettings: NextPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'password' | 'sessions' | '2fa' | 'login' | 'encryption' | 'api' | 'events'>('password');
  ...
  const handleArraySettingAdd = (section: keyof SecuritySettings, field: string, value: string) => {
    ...
    setSettings(prev => ({
      ...
      [section]: {
        ...prev[section],
        [field]: [...(prev[section][field as keyof typeof prev[section]] as string[]), value],
      },
    }));
    setHasChanges(true);
  };

  const handleArraySettingRemove = (section: keyof SecuritySettings, field: string, index: number) => {
    setSettings(prev => ({
      ...prev,
      [section]: {
        ...prev[section],
        [field]: (prev[section][field as keyof typeof prev[section]] as string[]).filter((_, i) => i !== index),
      },
    }));
    setHasChanges(true);
  };
    ...
    <FuturisticDashboardLayout>
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className={`text-3xl font-bold mb-1 ${
                settings.twoFactor.enabled ? 'text-green-400' : 'text-red-400'
              }`}>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className={`text-3xl font-bold mb-1 ${
                unresolvedEvents === 0 ? 'text-green-400' :
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className={`text-3xl font-bold mb-1 ${
                settings.encryption.dataEncryption ? 'text-green-400' : 'text-red-400'
              }`}>
        ...
        >
          {activeTab === 'password' && (
            <Card>
              <CardHeader title="Password Policy Configuration" />
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('passwordPolicy', 'minLength', Number(e.target.value))}
                      min="4"
                      max="32"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('passwordPolicy', 'maxAge', Number(e.target.value))}
                      min="0"
                      max="365"
                    />
                  </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('passwordPolicy', 'preventReuse', Number(e.target.value))}
                    min="0"
                    max="24"
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {[
                    ...
                    <div key={requirement.key} className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                      <span className="text-white">{requirement.label}</span>
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={() => handleSettingChange('passwordPolicy', requirement.key, !(settings.passwordPolicy as any)[requirement.key])}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          (settings.passwordPolicy as any)[requirement.key] ? 'bg-primary-500' : 'bg-dark-600'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            (settings.passwordPolicy as any)[requirement.key] ? 'translate-x-6' : 'translate-x-1'
                          }`}
                        />
                      </motion.button>
                    </div>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      passwordStrength >= 80 ? 'bg-green-500/20 text-green-400' :
                  ...
                  <div className={`w-full h-2 rounded-full ${
                    ...
                    <div 
                      className={`h-full rounded-full transition-all duration-300 ${
                        passwordStrength >= 80 ? 'bg-green-400' :
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('sessionManagement', 'maxSessions', Number(e.target.value))}
                      min="1"
                      max="10"
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('sessionManagement', 'sessionTimeout', Number(e.target.value))}
                      min="5"
                      max="480"
                    />
                    <p className="text-dark-400 text-sm mt-1">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('sessionManagement', 'rememberMeDuration', Number(e.target.value))}
                    min="1"
                    max="365"
                  />
                  <p className="text-dark-400 text-sm mt-1">
                ...
                <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => handleSettingChange('sessionManagement', 'logoutOnClose', !settings.sessionManagement.logoutOnClose)}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.sessionManagement.logoutOnClose ? 'bg-primary-500' : 'bg-dark-600'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.sessionManagement.logoutOnClose ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </motion.button>
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => handleSettingChange('twoFactor', 'enabled', !settings.twoFactor.enabled)}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.twoFactor.enabled ? 'bg-primary-500' : 'bg-dark-600'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                  ...
                  <>
                    <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={() => handleSettingChange('twoFactor', 'required', !settings.twoFactor.required)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          settings.twoFactor.required ? 'bg-primary-500' : 'bg-dark-600'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={method.key} className="flex items-center justify-between p-3 bg-dark-700 rounded-lg">
                            ...
                            <motion.button
                              ...
                              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                settings.twoFactor.methods.includes(method.key) ? 'bg-primary-500' : 'bg-dark-600'
                              }`}
                            >
                              <span
                                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                  settings.twoFactor.methods.includes(method.key) ? 'translate-x-6' : 'translate-x-1'
                                }`}
                              />
                            </motion.button>
                          </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                      ...
                      <div className="flex items-center space-x-3">
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                          onClick={() => handleSettingChange('twoFactor', 'backupCodes', !settings.twoFactor.backupCodes)}
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            settings.twoFactor.backupCodes ? 'bg-primary-500' : 'bg-dark-600'
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                              settings.twoFactor.backupCodes ? 'translate-x-6' : 'translate-x-1'
                            }`}
                          />
                        </motion.button>
                        {settings.twoFactor.backupCodes && (
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('loginSecurity', 'maxFailedAttempts', Number(e.target.value))}
                      min="3"
                      max="10"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('loginSecurity', 'lockoutDuration', Number(e.target.value))}
                      min="5"
                      max="1440"
                    />
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    onClick={() => handleSettingChange('loginSecurity', 'enableCaptcha', !settings.loginSecurity.enableCaptcha)}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                      settings.loginSecurity.enableCaptcha ? 'bg-primary-500' : 'bg-dark-600'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                        settings.loginSecurity.enableCaptcha ? 'translate-x-6' : 'translate-x-1'
                      }`}
                    />
                  </motion.button>
                </div>
                ...
                <div>
                  ...
                  {settings.loginSecurity.ipWhitelist.length > 0 && (
                      ...
                      {settings.loginSecurity.ipWhitelist.map((ip, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-dark-700 rounded-lg">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => handleArraySettingRemove('loginSecurity', 'ipWhitelist', index)}
