...
interface OnboardingApplication {
  ...
  stage: 'documentation' | 'verification' | 'financial_assessment' | 'approval' | 'completed' | 'rejected';
  ...
  documents: {
    ...
    fireServiceCertificate: boolean;
  };
  riskScore: number;
...
const DealerOnboarding = () => {
  const [activeView, setActiveView] = useState<'overview' | 'applications' | 'new_application'>('overview');
        ...
        <Card className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Proposed station name"
                  required
                />
              </div>
              <div>
            ...
            <div className="flex justify-end space-x-4">
              <Button type="button" variant="outline" onClick={() => setActiveView('applications')}>
                Cancel
              </Button>
              <Button type="submit">
                Submit Application
  ...
  const ApplicationDetails = ({ application }: { application: OnboardingApplication }) => (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
      exit={{ opacity: 0, x: -20 }}
          ...
          {onboardingStages.map((stage, index) => (
            <div key={stage.key} className="flex flex-col items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                application.stage === stage.key ? `bg-${stage.color}-600 text-white` :
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            {requiredDocuments.map((doc) => (
              <div key={doc.key} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 space-y-2">
            <Button className="w-full" disabled={application.completionPercentage < 100}>
              Approve Application
            </Button>
  ...
  return (
    <FuturisticDashboardLayout title="Dealer Onboarding" subtitle="Streamlined dealer application and approval process">
            ...
            >
              <Card className="p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button onClick={() => setActiveView('new_application')}>
                    New Application
                  </Button>
                </div>
