...
const TransactionsMonitoring = () => {
    ...
    const [transactionFilter, setTransactionFilter] = (0, react_1.useState)('all');
      ...
      <div className="space-y-8">
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col lg:flex-row lg:items-center justify-between">
          ...
          <div className="flex items-center space-x-3 mt-4 lg:mt-0">
            ...
            <select className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value={selectedTimeRange} onChange={(e) => setSelectedTimeRange(e.target.value)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }}>
            <Card_1.Card className="p-6">
              ...
              <charts_1.LineChart data={hourlyVolumeData} height={300}/>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.6 }}>
            <Card_1.Card className="p-6">
              ...
              <charts_1.PieChart data={paymentMethodData} height={300}/>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}>
          <Card_1.Card className="p-6">
            ...
            <charts_1.BarChart data={stationRevenueData} height={400}/>
          </Card_1.Card>
        </framer_motion_1.motion.div>
          ...
          <Card_1.Card className="p-6">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6">
              ...
              <div className="flex space-x-2 mt-4 lg:mt-0">
                <input type="text" placeholder="Search transactions..." className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"/>
                <select className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value={transactionFilter} onChange={(e) => setTransactionFilter(e.target.value)}>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {recentTransactions.map((transaction, index) => (<framer_motion_1.motion.tr key={transaction.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 + index * 0.1 }} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex space-x-2">
                          <framer_motion_1.motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="p-2 text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-lg transition-colors" title="View Receipt">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                          </framer_motion_1.motion.button>
                          {transaction.status === 'failed' && (<framer_motion_1.motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="p-2 text-green-600 hover:bg-green-100 dark:hover:bg-green-900 rounded-lg transition-colors" title="Retry Transaction">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
exports.default = TransactionsMonitoring;
