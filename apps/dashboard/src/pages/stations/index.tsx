      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <Card className="p-6">
              ...
              <PieChart data={fuelDistributionData} height={300} />
            </Card>
          </motion.div>
        </div>
        ...
        >
          <Card className="p-6">
            ...
            <BarChart data={stationPerformanceData} height={400} />
          </Card>
        </motion.div>
