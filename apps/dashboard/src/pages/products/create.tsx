...
const CreateProduct = () => {
  ...
  const handleQualityParameterChange = (field: string, value: any) => {
    setFormData(prev => ({
      ...prev,
      qualityParameters: {
  ...
  const handleRegulatoryChange = (field: string, value: any) => {
    setFormData(prev => ({
      ...prev,
      regulatoryInfo: {
        ...prev.regulatoryInfo,
            ...
            <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="e.g., Petrol 95 Octane"
                        error={errors.name}
                      />
                    </div>
              ...
              {activeTab === 'specifications' && (
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.octaneRating || ''}
                          onChange={(e) => handleSpecificationChange('octaneRating', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleSpecificationChange('density', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => handleSpecificationChange('flashPoint', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.pourPoint || ''}
                          onChange={(e) => handleSpecificationChange('pourPoint', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.sulphurContent || ''}
                          onChange={(e) => handleSpecificationChange('sulphurContent', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.apiGravity || ''}
                          onChange={(e) => handleSpecificationChange('apiGravity', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.netHeat || ''}
                          onChange={(e) => handleSpecificationChange('netHeat', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.01"
                          value={formData.specifications.benzeneContent || ''}
                          onChange={(e) => handleSpecificationChange('benzeneContent', parseFloat(e.target.value) || undefined)}
                          placeholder="e.g., 1.0"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.aromatics || ''}
                          onChange={(e) => handleSpecificationChange('aromatics', parseFloat(e.target.value) || undefined)}
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          step="0.1"
                          value={formData.specifications.olefins || ''}
                          onChange={(e) => handleSpecificationChange('olefins', parseFloat(e.target.value) || undefined)}
                  ...
                  {formData.type === 'lubricant' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium mb-2">Viscosity</label>
                        <Input
                          value={formData.specifications.viscosity || ''}
                          onChange={(e) => handleSpecificationChange('viscosity', e.target.value)}
                          placeholder="e.g., SAE 10W-40"
                        />
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        type="number"
                        step="0.01"
                        value={formData.qualityParameters.moistureContent || ''}
                        onChange={(e) => handleQualityParameterChange('moistureContent', parseFloat(e.target.value) || undefined)}
                    ...
                    <div>
                      ...
                      <Input
                        type="number"
                        step="0.01"
                        value={formData.qualityParameters.sedimentContent || ''}
                        onChange={(e) => handleQualityParameterChange('sedimentContent', parseFloat(e.target.value) || undefined)}
                    ...
                    <div>
                      ...
                      <Input
                        type="number"
                        step="0.1"
                        value={formData.qualityParameters.copper || ''}
                        onChange={(e) => handleQualityParameterChange('copper', parseFloat(e.target.value) || undefined)}
                        placeholder="e.g., 0.1"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        value={formData.qualityParameters.corrosion || ''}
                        onChange={(e) => handleQualityParameterChange('corrosion', e.target.value)}
                        placeholder="e.g., 1a"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        type="number"
                        value={formData.qualityParameters.oxidationStability || ''}
                        onChange={(e) => handleQualityParameterChange('oxidationStability', parseInt(e.target.value) || undefined)}
                        placeholder="e.g., 480"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <Input
                            type="number"
                            step="0.1"
                            value={formData.safetyData.flashPointMin || ''}
                            onChange={(e) => handleSafetyDataChange('flashPointMin', parseFloat(e.target.value) || undefined)}
                            placeholder="e.g., -40.0"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <Input
                            type="number"
                            step="0.1"
                            value={formData.safetyData.autoIgnitionTemp || ''}
                            onChange={(e) => handleSafetyDataChange('autoIgnitionTemp', parseFloat(e.target.value) || undefined)}
                        ...
                        <div>
                          ...
                          <Input
                            type="number"
                            step="0.1"
                            value={formData.safetyData.vaporPressure || ''}
                            onChange={(e) => handleSafetyDataChange('vaporPressure', parseFloat(e.target.value) || undefined)}
                            placeholder="e.g., 45.0"
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <Input
                            value={formData.safetyData.toxicity || ''}
                            onChange={(e) => handleSafetyDataChange('toxicity', e.target.value)}
                            placeholder="e.g., Low"
                          />
                        </div>
                      </div>
                      ...
                      <div className="mt-4">
                        ...
                        <textarea
                          value={formData.safetyData.environmentalImpact || ''}
                          onChange={(e) => handleSafetyDataChange('environmentalImpact', e.target.value)}
                          placeholder="Describe environmental impact and precautions..."
                          className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          rows={3}
                        />
                      </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          <label className="flex items-center gap-2">
                            <input
                              type="checkbox"
                              checked={formData.regulatoryInfo.npaApproved}
                              onChange={(e) => handleRegulatoryChange('npaApproved', e.target.checked)}
                              className="rounded"
                            />
                          ...
                          <label className="flex items-center gap-2">
                            <input
                              type="checkbox"
                              checked={formData.regulatoryInfo.epaCompliant}
                              onChange={(e) => handleRegulatoryChange('epaCompliant', e.target.checked)}
                              className="rounded"
                            />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <Input
                              value={formData.regulatoryInfo.ghsClassification || ''}
                              onChange={(e) => handleRegulatoryChange('ghsClassification', e.target.value)}
                              placeholder="e.g., Flam. Liq. 2"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <Input
                              value={formData.regulatoryInfo.unNumber || ''}
                              onChange={(e) => handleRegulatoryChange('unNumber', e.target.value)}
                          ...
                          <div>
                            ...
                            <Input
                              value={formData.regulatoryInfo.packingGroup || ''}
                              onChange={(e) => handleRegulatoryChange('packingGroup', e.target.value)}
                              placeholder="e.g., II"
                            />
                          </div>
                        </div>
