        ...
        <div className="text-center py-16">
          ...
          <Link href="/suppliers">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-4 px-6 py-3 bg-gradient-primary text-white rounded-xl font-medium"
            >
              Back to Suppliers
            </motion.button>
          </Link>
          ...
          {activeTab === 'overview' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <a 
                      href={`https://${supplier.businessInfo.website}`} 
                      target="_blank" 
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {supplier.risk.factors.map((factor, index) => (
              ...
              <Card className="p-6">
                ...
                <LineChart data={performanceTrendData} height={200} />
              </Card>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="p-6">
                  ...
                  <PieChart data={contractDistributionData} height={300} />
                </Card>
                
                <Card className="p-6">
                  <h3 className="text-lg font-semibold mb-4">Delivery Performance</h3>
                  <BarChart data={deliveryPerformanceData} height={300} />
                </Card>
              </div>
            </div>
          )}
          ...
          {activeTab === 'performance' && (
            <div className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <LineChart data={performanceTrendData} height={400} />
              </Card>
            </div>
          )}
                      ...
                      <div className="flex items-center space-x-3">
                        <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                          <div 
                            ...
                            style={{ width: `${(supplier.financial.creditUsed / supplier.financial.creditLimit) * 100}%` }}
                          />
                        </div>
