...
const UPPFRoutes: NextPage = () => {
  ...
  const [routePerformance] = useState<RoutePerformance[]>([
    {
      routeId: '1',
      month: '2025-01',
      claims: 12,
  ...
  const [activeTab, setActiveTab] = useState<'routes' | 'performance'>('routes');
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedRoute.fuelTypes.map((fuel) => (
                    <span
                      key={fuel}
        ...
        >
          {selectedRoute && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {getRoutePerformance(selectedRoute.id).map((performance, index) => (
                  <div key={index} className="p-4 bg-dark-900/50 rounded-lg border border-white/10">
