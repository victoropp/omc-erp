...
const SalesReports = () => {
    const [selectedDateRange, setSelectedDateRange] = (0, react_1.useState)('7d');
    ...
    const getGrowthIcon = (growth) => {
        return growth >= 0 ? (<svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Card_1.Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" value={selectedProduct} onChange={(e) => setSelectedProduct(e.target.value)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <framer_motion_1.motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.9 }}>
            <Card_1.Card className="p-6">
              ...
              <charts_1.BarChart data={stationPerformanceData} height={300}/>
            </Card_1.Card>
          </framer_motion_1.motion.div>
          ...
          <framer_motion_1.motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.0 }}>
            <Card_1.Card className="p-6">
              ...
              <charts_1.BarChart data={hourlySalesData} height={300}/>
            </Card_1.Card>
          </framer_motion_1.motion.div>
        </div>
          ...
          <Card_1.Card className="p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {topProductsData.map((product, index) => (<framer_motion_1.motion.tr key={product.product} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 + index * 0.1 }} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
          ...
          <Card_1.Card className="p-6">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {stationDetailsData.map((station, index) => (<framer_motion_1.motion.tr key={station.station} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.4 + index * 0.1 }} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
