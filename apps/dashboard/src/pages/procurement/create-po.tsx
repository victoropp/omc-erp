...
const CreatePurchaseOrderPage: NextPage = () => {
  ...
  const sampleBudgetInfo: BudgetInfo = {
              ...
              {stepNum < 3 && (
                <div
                  className={`w-16 h-1 transition-colors ${
                    stepNum < step ? 'bg-green-500' : 'bg-dark-600'
                  }`}
                />
              )}
            </div>
        ...
        >
          {step === 1 && (
            <div className="space-y-6">
              <Card>
                <CardHeader title="Basic Purchase Order Information" />
                <CardContent>
                  <div className="space-y-6">
                    {/* Supplier Selection */}
                    <div>
                      ...
                      />
                      {selectedSupplier && (
                        <div className="mt-4 p-4 bg-dark-800/30 rounded-lg border border-dark-600">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Select
                        ...
                        onChange={(value) => setPOData({ ...poData, department: value })}
                        required
                      />
                      <Select
                        label="Priority"
                        ...
                        onChange={(value) => setPOData({ ...poData, priority: value })}
                        required
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <Input
                        ...
                        onChange={(e) => setPOData({ ...poData, requestedBy: e.target.value })}
                        required
                      />
                    </div>
                ...
                <CardContent>
                  <div className="space-y-6">
                    {lineItems.map((item, index) => (
                      <div key={item.id} className="p-4 bg-dark-800/30 rounded-lg border border-dark-600">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                          ...
                          <Input
                            ...
                            readOnly
                            className="bg-dark-800/50 font-medium"
                          />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <Input
                            ...
                            placeholder="Special specifications or requirements"
                          />
                          <Input
                            label="Expected Delivery"
                            type="date"
                            value={item.expectedDelivery}
                            onChange={(e) => handleLineItemChange(index, 'expectedDelivery', e.target.value)}
                          />
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="mt-6 p-4 bg-primary-500/10 rounded-lg border border-primary-500/30">
                    ...
                    {budgetInfo && totalAmount > budgetInfo.availableBudget && (
          ...
          {step === 3 && (
            <div className="space-y-6">
              <Card>
                <CardHeader title="Review Purchase Order" />
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {lineItems.filter(item => item.productId && item.quantity > 0).map((item, index) => (
                          <div key={item.id} className="p-4 bg-dark-800/30 rounded-lg border border-dark-600">
