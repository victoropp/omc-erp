...
const AutomatedPricingWorkflows = () => {
  ...
  const loadAutomationData = async () => {
    try {
      ...
      toast.success('Automation data loaded successfully');
    } catch (error) {
  ...
  const executeRule = async (ruleId: number) => {
    try {
      toast.loading('Executing automation rule...');
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex space-x-4">
            <button
              onClick={() => setNewRule({ ...newRule, name: 'New Rule' })}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <Card className="p-6">
              <CardHeader title="Automation Performance" subtitle="Monthly automation rate trends" />
              <CardContent>
                <LineChart data={mockData.performance} height={300} />
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="p-6">
              <CardHeader title="Time Savings" subtitle="Manual vs automated task hours" />
              <CardContent>
                <BarChart data={mockData.timeSavings} height={300} />
              </CardContent>
            </Card>
          </motion.div>
        </div>
        ...
        >
          <Card className="p-6">
            <CardHeader title="Active Workflows" subtitle="Currently running automation workflows" />
            <CardContent>
        ...
        >
          <Card className="p-6">
            <CardHeader title="Automation Rules" subtitle="Configure and manage pricing automation rules" />
            <CardContent>
                        ...
                        <td className="py-3 px-4">
                          <div className="flex space-x-2">
                            <button
                              ...
                              className="px-3 py-1 bg-blue-500 hover:bg-blue-600 disabled:bg-gray-500 disabled:cursor-not-allowed text-white rounded text-xs transition-colors"
                            >
                              Execute
                            </button>
        ...
        >
          <Card className="p-6">
            <CardHeader title="Create New Automation Rule" subtitle="Set up a new automated pricing workflow" />
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full glass px-3 py-2 rounded-lg border border-white/20 bg-white/10 text-white placeholder-gray-400"
                  />
                </div>
              ...
              <div className="mt-6 flex space-x-4">
                ...
                <button
                  onClick={() => setNewRule({ name: '', trigger: 'price_change', conditions: [], actions: [], enabled: true })}
...
export default AutomatedPricingWorkflows;