      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                {exPumpCalculation.components.map((component, index) => (
                  <motion.div
                    key={component.name}
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.2 + index * 0.05 }}
                    className="flex justify-between items-center py-2 px-4 rounded-lg bg-gray-50 dark:bg-gray-700"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {pbuComponents.map((category, categoryIndex) => (
              <motion.div
              ...
              >
                ...
                <div className="space-y-3">
                  {category.components.map((component) => (
                    <div key={component.code} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
...
export default PriceBuildUpPage;