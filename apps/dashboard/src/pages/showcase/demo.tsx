...
const DemoEnvironment: NextPage = () => {
  ...
  const startDemo = (demoId: string) => {
    ...
    setIsRunning(true);
    setCompletedSteps([]);
    toast.success('Demo started! Follow the guided steps.');
  };
  ...
  const nextStep = () => {
    ...
    if (demo && currentStep < demo.steps.length - 1) {
      ...
      toast.info(`Step ${currentStep + 2}: ${demo.steps[currentStep + 1].title}`);
    } else {
      completeDemo();
    }
  };
  ...
  const completeDemo = () => {
    ...
    if (demo) {
      setCompletedSteps(prev => [...prev, currentStep]);
      setIsRunning(false);
      toast.success(`Demo completed! ${demo.outcome}`);
    }
  };
    ...
    <FuturisticDashboardLayout>
      <div className="space-y-8">
        ...
        {activeDemo && currentDemo && (
          ...
          >
            <Card className="border-primary-500/50 bg-dark-800/95 backdrop-blur-sm">
                  ...
                  <div className="bg-dark-700 rounded-lg p-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <Button
                        variant="primary"
                        onClick={nextStep}
                        className={currentDemo.steps[currentStep].highlight ? 'animate-pulse' : ''}
                      >
                  ...
                  <CardContent className="p-6 h-full flex flex-col">
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="space-y-2">
                        {demo.steps.slice(0, 3).map((step, stepIndex) => (
        ...
        {!activeDemo && (
          <Card>
            <CardHeader title="Demo Environment Status" />
            <CardContent>
        ...
        {!activeDemo && (
          <Card>
            <CardHeader title="Live System Metrics" />
            <CardContent>
              <div className="h-64">
                <RealTimeChart
                  type="area"
