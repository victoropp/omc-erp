...
const ComponentsShowcase = () => {
    ...
    const [currentDemo, setCurrentDemo] = (0, react_1.useState)('overview');
    ...
    const renderDemoContent = () => {
        switch (currentDemo) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <charts_1.RealTimeRevenueChart height={300} refreshInterval={5000} enableWebSocket={true}/>
              <charts_1.RealTimeSalesChart height={300} refreshInterval={5000}/>
            </div>
            <div className="w-full">
              <charts_1.RealTimeTransactionChart height={350} refreshInterval={5000} enableWebSocket={true}/>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                    ...
                    ].map((stat, index) => (<framer_motion_1.motion.div key={stat.title} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }}>
                  <ui_1.Card>
            ...
            case 'tables':
                return (<div className="space-y-8">
            <ui_1.Card>
              <ui_1.CardHeader title="UPPF Claims Management"/>
              <ui_1.CardContent>
                <tables_1.ClaimsTable showActions={true}/>
              </ui_1.CardContent>
            </ui_1.Card>

            <ui_1.Card>
              <ui_1.CardHeader title="Live Transactions"/>
              <ui_1.CardContent>
                <tables_1.TransactionTable showActions={true} maxRecords={50}/>
              </ui_1.CardContent>
            </ui_1.Card>
          </div>);
            case 'forms':
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Form Demo Cards */}
              <ui_1.Card className="cursor-pointer hover:shadow-xl transition-shadow" onClick={() => setOnboardingOpen(true)}>
                <ui_1.CardContent className="p-6 text-center">
                  ...
                  <ui_1.Badge variant="primary">Interactive Demo</ui_1.Badge>
                </ui_1.CardContent>
              </ui_1.Card>

              <ui_1.Card className="cursor-pointer hover:shadow-xl transition-shadow" onClick={() => setModalOpen(true)}>
                <ui_1.CardContent className="p-6 text-center">
                  ...
                  <ui_1.Badge variant="success">Form Wizard</ui_1.Badge>
                </ui_1.CardContent>
              </ui_1.Card>
              ...
              <ui_1.Card>
                <ui_1.CardContent className="p-6 text-center">
                  ...
                  <ui_1.Badge variant="warning">Coming Soon</ui_1.Badge>
                </ui_1.CardContent>
              </ui_1.Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <ui_1.Card>
                <ui_1.CardHeader title="Form Features"/>
              ...
              <ui_1.Card>
                <ui_1.CardHeader title="Integration Features"/>
                <ui_1.CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <ui_1.Card>
                <ui_1.CardHeader title="Notification Types"/>
                <ui_1.CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    ].map((notif, index) => (<div key={index} className={`p-3 rounded-lg border-l-4 ${notif.type === 'success' ? 'bg-green-500/10 border-green-500' :
                            notif.type === 'warning' ? 'bg-yellow-500/10 border-yellow-500' :
                                notif.type === 'error' ? 'bg-red-500/10 border-red-500' :
                                    'bg-blue-500/10 border-blue-500'}`}>
                        <div className="flex items-start space-x-3">
                          <div className={`w-5 h-5 rounded-full flex items-center justify-center ${notif.type === 'success' ? 'bg-green-500' :
              ...
              <ui_1.Card>
                <ui_1.CardHeader title="Real-time Features"/>
                <ui_1.CardContent className="space-y-4">
                  <div className="flex items-center space-x-3">
                  ...
                  <div className="mt-6 pt-4 border-t border-dark-700">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        'Compliance Alerts',
                        'Price Changes',
                    ].map((category, index) => (<div key={index} className="flex items-center justify-between">
                          <span className="text-white text-sm">{category}</span>
                          <ui_1.Badge variant="outline" className="text-xs">Active</ui_1.Badge>
                        </div>))}
                    </div>
                  </div>
                </ui_1.CardContent>
      ...
      <div className="space-y-8">
        ...
        <framer_motion_1.motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <ui_1.NotificationSystem enableWebSocket={true}/>
        ...
        <div className="flex space-x-1 bg-dark-800 p-1 rounded-lg">
          {demoSections.map((section) => (<button key={section.id} onClick={() => setCurrentDemo(section.id)} className={`flex-1 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${currentDemo === section.id
        ...
        {/* Demo Content */}
        <framer_motion_1.motion.div key={currentDemo} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
          {renderDemoContent()}
        </framer_motion_1.motion.div>

        {/* Modals */}
        <forms_1.DealerOnboardingWizard isOpen={onboardingOpen} onClose={() => setOnboardingOpen(false)} onComplete={(data) => {
            console.log('Demo completed:', data);
            setOnboardingOpen(false);
        }}/>

        <ui_1.Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="UPPF Claims Demo">
          <div className="p-6">
            ...
            <div className="mt-6 flex justify-end">
              <ui_1.Button variant="primary" onClick={() => setModalOpen(false)}>
                Got it
              </ui_1.Button>
            </div>
          </div>
