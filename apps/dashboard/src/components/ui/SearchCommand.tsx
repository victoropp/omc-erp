              ...
              <div className="glass rounded-2xl border border-white/10 shadow-glass-lg overflow-hidden">
                ...
                <div className="flex items-center px-6 py-4 border-b border-white/10">
                  ...
                  <input
                    ...
                    placeholder="Search for stations, transactions, pricing..."
                    className="flex-1 bg-transparent text-white placeholder-dark-400 outline-none text-lg"
                  />
                  <button
                    onClick={() => setIsOpen(false)}
                    className="ml-3 text-dark-400 hover:text-white transition-colors"
                  >
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {result.subtitle && (
                                    <div className="text-sm text-dark-500 truncate">{result.subtitle}</div>
                                  )}
                                </div>
                ...
                {/* Footer */}
                {results.length > 0 && (
                  <div className="px-6 py-3 border-t border-white/10 text-xs text-dark-400">
