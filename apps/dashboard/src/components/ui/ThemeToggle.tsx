...
export function ThemeToggle() {
  const { mode, actualTheme, toggleTheme, isSystemTheme } = useTheme();
      ...
      >
        ...
        {isSystemTheme && (
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-1 -right-1 w-3 h-3 bg-blue-500 rounded-full border-2 border-current"
