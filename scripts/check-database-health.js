...
const health_check_1 = require("../packages/database/src/health-check");
const data_source_1 = require("../packages/database/src/data-source");
async function main() {
    ...
    try {
        ...
        const healthStatus = await health_check_1.databaseHealthChecker.checkAllDatabases();
...
main();
//# sourceMappingURL=check-database-health.js.map